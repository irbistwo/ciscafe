...
export const CafeAuthProviderContext:React.Context<any> = createContext({});
export const CafeAuthProvider = ({children}) => {
  ...
  //  const[beedtype,setBeedType]=useState<IBeedType>({beedtype:"Dine"});
    ...
    return (
        <CafeAuthProviderContext.Provider value={{user,setUser,token,
            googleLogin: async () => {
                try {
            ...
            {children}
        </CafeAuthProviderContext.Provider>
    );
}
